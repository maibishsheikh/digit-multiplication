...
export default function GuidedPractice({ questions, worldAccent, onComplete }) {
  ...
  return (
    <div style={{ position: 'relative', width: '100%', maxWidth: 640, display: 'flex', flexDirection: 'column', gap: 12, height: '100%' }}>
      ...
      <FeedbackOverlay visible={showFeedback} correct={selected === question?.correctAnswer}
        message={selected === question?.correctAnswer ? "Excellent! Simplified perfectly! 🎉" : "Not quite — good try! 🤔"}
