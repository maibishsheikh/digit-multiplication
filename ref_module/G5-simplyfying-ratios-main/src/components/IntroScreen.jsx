...
const JOURNEY = [
  ...
  { num: '02', icon: '📖', label: 'Story',    desc: 'Leo & Aria\'s shop' },
  ...
  return (
    <div className="intro-wrap">
      ...
      <div className="intro-top-badge">
        ✨ Curriculum · Simplifying Ratios Grade 5 & 6
      </div>

      {/* Main Title */}
      <h1 className="intro-title">
        <span className="text-orange">Simplifying</span> <span className="text-white">Ratios</span>
      </h1>
      <h2 className="intro-subtitle">RatioQuest · Master Equal Groups & Simplest Forms</h2>

      {/* Mascot Row */}
      <div className="intro-mascot-row">
        <div className="intro-mascot-circle">🦁</div>
        <div className="intro-speech-bubble">
          Hi! I'm Leo. Ready to<br />simplify ratios and find equal groups? 🍓🥤
        </div>
      </div>

      {/* Description */}
      <p className="intro-desc">
        Learn how to compare quantities, find the <span className="text-yellow">Greatest Common Factor (GCF)</span>, scale recipes, and reduce any ratio to its simplest form!
      </p>
