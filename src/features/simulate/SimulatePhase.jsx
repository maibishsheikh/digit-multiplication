...
import BreakItApartSim from './simulations/BreakItApart.jsx';
import RegroupMultiplySim from './simulations/RegroupMultiply.jsx';
...
const STATIONS = [
  { id: 0, icon: '🧩', title: 'Break It Apart',       subtitle: 'Multiply by place value, then add',   Component: BreakItApartSim },
  { id: 1, icon: '🔢', title: 'Regroup & Multiply',   subtitle: 'The standard algorithm, step by step', Component: RegroupMultiplySim },
