    ...
    return (
      <div className="boss-banner glass-card">
        ...
        <div className="conversion-fact-box" style={{ marginBottom: 20 }}>
          🔑 Remember: <span className="mass-value">Break it apart, or regroup as you multiply!</span>
        </div>
  ...
  return (
    <div style={{ position: 'relative', width: '100%' }}>
      ...
      <FeedbackOverlay
        ...
        message={selected === question?.correctAnswer ? "That's exactly right! Well done! 🎉" : "Not quite! Remember: break it apart by place value, or regroup carefully"}
