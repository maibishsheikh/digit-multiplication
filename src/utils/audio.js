...
export const sounds = {
  ...
  defeat:   () => { tone(220, 0.15, 'sawtooth'); setTimeout(() => tone(164, 0.25, 'sawtooth'), 120); },
  levelUp:  () => { tone(440, 0.08); setTimeout(() => tone(554, 0.08), 70); setTimeout(() => tone(659, 0.14), 140); },
};
