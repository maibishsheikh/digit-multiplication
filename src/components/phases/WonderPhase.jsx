      ...
      <div className="wonder-content anim-slide-up">
        ...
        <div className="wonder-card glass-card">
          ...
          <div className="wonder-number-display">
            <span className="number-display wonder-num">2,314 × 4 ➔ ?</span>
          </div>

          <div className="wonder-question-card">
            <p className="body-text wonder-q">
              If Max needs to pack <strong className="wonder-em">4 giant festival boxes</strong>, each holding <strong className="wonder-em">2,314 mini cupcakes</strong>…
            </p>
            <p className="body-text wonder-q">
              What is the <span className="wonder-highlight">total number of cupcakes</span>, and how can we calculate it in seconds without adding 2,314 four times?
            </p>
          </div>

          {/* Mascot */}
          <div className="wonder-mascot-row">
            <Mascot mood="curious" message="Let's investigate how breaking numbers apart and using the standard algorithm solve big multiplication fast!" size="sm" />
          </div>
